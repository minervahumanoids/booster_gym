...
def generate_launch_description():
    # 获取xacro文件路径
    urdf_package_path = get_package_share_directory('urdf_left_with_force_sensor')
    default_xacro_path = os.path.join(urdf_package_path, 'urdf', 'urdf_left_with_force_sensor.xacro')
